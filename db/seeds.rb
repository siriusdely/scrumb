...
first_scrum = Scrum.create(
  ...
  tasks: "Put all the items in a blender and whizz for 1 min until smooth. Pour the mixture into two glasses to serve.",
...
second_scrum = Scrum.create(
  ...
  tasks: "Put all of the items into a bullet or smoothie maker, add a large splash of water and blitz. Add more water until you have the desired consistency.",
